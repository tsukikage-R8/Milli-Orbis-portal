...
const MEMBERS = [
  ...
  },
  {
    ...
    birthday: "",
    debut: "",
    catch: "いちごモチーフの癒し系新人タレント。正式情報は後日発表！",
    fanName: "？？？",
    fanMark: '<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><g fill="#f29bb8"><path d="M12 20.4C6.8 16.4 3.6 12.9 3.6 9.2 3.6 6.6 5.6 4.6 8.2 4.6c1.5 0 2.9.7 3.8 1.9.9-1.2 2.3-1.9 3.8-1.9 2.6 0 4.6 2 4.6 4.6 0 3.7-3.2 7.2-8.4 11.2z"/></g><g fill="#ffe14d"><path d="M8.3 4.7c.3-1 .9-1.8 1.7-2.3-.1 1.2-.7 2.2-1.7 2.3z"/><path d="M12.4 4.3c.5-.9 1.2-1.5 2.1-1.9-.2 1.2-.9 2.1-2.1 1.9z"/></g></svg>',
    calls: "？？？",
    profile: "いちごモチーフ・リボンやレースなどの可愛い系・ピンク・青・白系のカラーリングで活動予定の新人タレント。名前・誕生日など正式情報は後日発表。",
    skills: "？？？",
    phrases: [],
    likes: "？？？",
    dislikes: "？？？",
    ...
    en: {
      gen: "???",
      catch: "A new healing-oriented talent with a strawberry motif. Official details to be announced!",
      fanName: "???",
      calls: "???",
      profile: "A new talent planned to appear with a strawberry motif, cute ribbons and lace, in pink / blue / white colors. Name, birthday, and other details to be announced.",
      skills: "???",
      likes: "???",
      dislikes: "???",
      catchphrase: "???"
